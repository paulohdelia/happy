...
const CreateOrphanage: React.FC = () => {
  ...
  const [isOpenOnWeekends, setIsOpenOnWeekends] = useState(true);
  ...
  const handleSubmit = useCallback(
    async (event: FormEvent) => {
      ...
      data.append('open_on_weekends', String(isOpenOnWeekends));
          ...
          <fieldset>
            ...
            <div className="input-block">
              ...
              <div className="button-select">
                <button
                  type="button"
                  className={isOpenOnWeekends ? 'active' : ''}
                  onClick={() => setIsOpenOnWeekends(true)}
                >
                  Sim
                </button>
                <button
                  type="button"
                  className={isOpenOnWeekends ? '' : 'active'}
                  onClick={() => setIsOpenOnWeekends(false)}
                >
                  Não
                </button>
              </div>
